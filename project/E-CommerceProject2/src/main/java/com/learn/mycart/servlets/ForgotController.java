...
import com.learn.mycart.dao.ForgotDao;
...
public class ForgotController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("submit"))
		{
			...
			User user=new User();
			com.learn.mycart.dao.ForgotDao dao=new com.learn.mycart.dao.ForgotDao();
			...
			else
			{
				...
				final String Senderid = "vyomesh002@gmail.com";
				final String password = "kiuqgryzmcpnmzgx";
				...
				try {
					...
					otpsession.setAttribute("UserData", user);
